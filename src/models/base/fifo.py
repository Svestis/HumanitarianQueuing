...
Implementing FIFO queue and calculate relevant metrics
...
def fifo(num_servers: int, original_df: pd.DataFrame = None, capacity: Optional[int] = None)\
        -> Tuple[pd.DataFrame, pd.DataFrame, list[list[tuple[datetime, datetime]]], dict]:
    """
    Simulate a FIFO multi-server queue M/M/c/K
